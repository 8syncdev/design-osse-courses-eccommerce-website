...
if DEBUG:
    ...
    FRONT_END_URL = FRONT_END_URL.split('|')[-1]
...
# CSRF_COOKIE_HTTPONLY = True #** Has fixed CSRF_COOKIE_HTTPONLY, because it is a security risk to set CSRF_COOKIE_HTTPONLY to False.
#* Content Security Policy settings
from .base.common.csp import * 
